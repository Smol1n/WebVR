var Sceeeeeeeeeene = document.getElementById("Sceeeeeeeeeene");
var Cameeeeeeeera = document.getElementById("Cameeeeeeeera");
...
const shoot = () => {
  ...
  let pos = Cameeeeeeeera.getAttribute("position");
  bullet.setAttribute(
    "src",
    "https://cdn.glitch.com/3f95a179-52df-437a-8866-43188d2fcd4d%2Fdownload.jpg?v=1633353636890"
  );
  bullet.setAttribute("position", pos);
  bullet.setAttribute("velocity", getDirection(Cameeeeeeeera, 30));
  bullet.setAttribute("dynamic-body", true);
  bullet.setAttribute("radius", 0.5);
  Sceeeeeeeeeene.appendChild(bullet);
};
